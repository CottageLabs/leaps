...
def interviewForm(sid):
    ...
    if student is None:
        ...
        student.save()
        flash('<span style="font-size:2em;">The post-interview form is complete and has been saved to the student record. The student\'s action plan will now be generated. You don\'t need to take anything further action</span>', 'success')
        return render_template('leaps/interviews/form.html', student=student, selections=selections)
